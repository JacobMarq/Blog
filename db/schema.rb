...
ActiveRecord::Schema.define(version: 2021_09_09_181818) do
  ...
  add_foreign_key "friendships", "User", column: "followed_id"
  add_foreign_key "friendships", "User", column: "follower_id"
